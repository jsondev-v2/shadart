...
class ShadSeparator extends StatelessWidget {
  const ShadSeparator({super.key, this.axis = Axis.horizontal, this.margin = EdgeInsets.zero});
  final Axis axis;
  final EdgeInsetsGeometry margin;
  @override
  Widget build(BuildContext context) => Padding(padding: margin, child: Container(
